...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid img_4">
        <div class="container text-center top_pad_1 width_1">
                ...
                <div class="col-auto p-4">
                    ...
                    <button type="submit" class="btn btn-light" formaction="restaurantsearch.php">SEARCH</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="alert back_color_brown">
        <h1>Innovative Food</h1>
    </div>

    <div class="container-fluid no-padding">
        <img src="image/food1.png" alt="" width="100%">
    </div>
    ...
    <div class="container-fluid no-padding bottom_height">
        <img src="image/food2.png" alt="" width="100%">
    </div>
