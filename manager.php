...
<html lang="en">
  <head>
    ...
    <title>Manager | POGINITY HOTEL</title>
  ...
  <body>
    ...
    <div class="container-fluid" style="background-color: #E5E7E9;">
        <div class="menubody">
            ...
            <div class="menu-flex">
                 <div class="padd">
                        <a href="staffmanagement.php" class="nolinkline">
                            <div class="topic_img">
                                <image src="image/mang02.jpg" class="crop">
                            </div>
                 ...
                 <div class="padd">
                        <a href="#" class="nolinkline">
                            <div class="topic_img">
                                <image src="image/mang03.jpg" class="crop">
                            </div>
                            <div class="topic_title">
                                Promotion
                            </div>
                 ...
                 <div class="padd">
                        <a href="hotel_info.html" class="nolinkline">
                            <div class="topic_img">
                                <image src="image/mang04.jpg" class="crop">
                            </div>
                            <div class="topic_title">
                                Hotel Information
                            </div>
